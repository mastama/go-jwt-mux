...
import (
	...
	"github.com/mastama/go-jwt-mux/config"
	"github.com/mastama/go-jwt-mux/helper"
...
func Login(w http.ResponseWriter, r *http.Request) {
	...
	var user model.User
	if err := model.DB.Where("username = ?", userInput.Username).First(&user).Error; err != nil {
		switch err {
